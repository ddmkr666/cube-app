...
const CORNER_CASES: CornerCaseDef[] = [
  ...
  { id: "h", name: "H (Double-Sune)", phase: "corners", alg: "R U R' U R U' R' U R U2 R'", description: "No corners oriented; headlights on left and right", tuple: [1, 2, 1, 2], orientationOffset: 1 },
  { id: "pi", name: "Pi (Bruno)", phase: "corners", alg: "R U2 R2 U' R2 U' R2 U2 R", description: "Headlights on the left, non-headlights on the right", tuple: [1, 1, 2, 2], orientationOffset: 0 },
